 ...
 * @returns Concatenated hex: IV + ciphertext + auth tag
 */
...
/**
 * Decrypts AES-256-GCM encrypted hex string
 * @param encryptedHex - Hex string containing: IV + ciphertext + auth tag
 * @param keyHex - 64-character hex string (256-bit key)
 ...
 * @returns True if key is valid 64-character hex string
 */
