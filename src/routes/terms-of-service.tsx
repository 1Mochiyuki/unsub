        ...
        <div className="mx-auto max-w-3xl px-4 py-12 md:py-20 animate-in fade-in duration-500">
            <div className="space-y-6">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">Last updated: February 12, 2026</p>
                </div>
                ...
                <div className="space-y-12">
                    <section className="space-y-4">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            By accessing or using UNSUB., you agree to be bound by these Terms of Service. If you
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            You agree to use UNSUB. only for lawful purposes. You agree not to:
                        </p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            UNSUB. is provided "as is" and "as available" without any warranties of any kind. I do
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            To the fullest extent permitted by law, UNSUB. shall not be liable for any indirect,
